      ...
      >
        <div className="flex flex-col h-full">
            ...
            {isProfileMenuOpen && (
              <div className="mt-2 p-2 bg-gray-800 rounded-md">
                <Link
                  ...
                  className="block px-2 py-1 text-sm hover:bg-gray-700 rounded"
                ...
                <Link
                  href="/logout"
                  className="block px-2 py-1 text-sm text-red-500 hover:bg-gray-700 rounded"
                  onClick={() => setIsProfileMenuOpen(false)}
                >
                  Logout
                </Link>
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <p className="text-xs uppercase text-gray-400 font-semibold mb-2 pl-3">
              Main Navigation
            </p>
            {navItems.map((item) => {
              const isActive =
