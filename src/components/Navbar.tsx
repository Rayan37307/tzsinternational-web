...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        {" "}
        <div className="px-4 pt-2 pb-4 space-y-1 border-t border-primary-700">
          {" "}
          {menuItems.map((item) =>
            isHashLink(item.href) ? (
              <ScrollLink
                ...
                className={`block px-3 py-2 rounded-md text-base font-medium cursor-pointer ${
                  isActive(item.href)
                    ? "text-secondary-300 bg-primary-900"
                    : "text-gray-100 hover:text-white hover:bg-primary-900"
                }`}
              >
                {" "}
          ...
          <ScrollLink
            ...
            duration={800}
            onClick={() => setIsMenuOpen(false)}
            className="block w-full mt-4 py-2 px-4 bg-gradient-to-r from-secondary-600 to-secondary-500 text-white rounded-md hover:from-secondary-700 hover:to-secondary-600 transition-all duration-300 text-center text-base font-medium shadow-md cursor-pointer"
          >
            {" "}
            Contact Now{" "}
          </ScrollLink>{" "}
